...
function App() {
  ...
  return (
      <div className="styling">
        ...
        <button onClick={ () => functionBased()} className = "function" >Div by using Functional Components</button>
        <button onClick={() => classBased()} itemID = "class">Div by using Class Components</button>
        {/* <Functionbased /> */}
